	    ...
	    public void run() {
	        ...
	        while (true) {
	            try {
	                ...
	                System.out.println("Cozinheiro #" + id + " está preparando " + pedido.getCategoria() + ": " + pedido.getNome());
	                Thread.sleep(pedido.getTempoPreparo());
	                System.err.println("Cozinheiro #" + id + " terminou de preparar " + pedido.getCategoria() + ": " + pedido.getNome());
